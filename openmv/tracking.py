...
thresholds = [(48, 92, -4, 37, 18, 102), # yellow
             (38, 49, 5, 37, -93, -59), # blue
             (46, 69, 59, 104, -10, 44)] # orange
...
sensor.set_windowing((33, 0, 230, 230)) # Robot B
...
sensor.set_auto_exposure(False, exposure_us = 18000)
