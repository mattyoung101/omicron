...
#define DebugFrame_init_default                  {{0, {0}}, {0, {0}}, 0, RDRect_init_default, RDPoint_init_default, 0, 0, 0, RDRect_init_default}
...
#define DebugFrame_init_zero                     {{0, {0}}, {0, {0}}, 0, RDRect_init_zero, RDPoint_init_zero, 0, 0, 0, RDRect_init_zero}
...
extern const pb_field_t DebugFrame_fields[10];
...
#define DebugFrame_size                          192162
#define DebugCommand_size                        415
#define RDMsgFrame_size                          192595
