...
#define FieldFile_init_default                   {0, 0, 0, 0, {{NULL}, NULL}}
#define FieldFile_init_zero                      {0, 0, 0, 0, {{NULL}, NULL}}

/* Field tags (for use in manual encoding/decoding) */
#define FieldFile_unitDistance_tag               1
#define FieldFile_cellCount_tag                  2
#define FieldFile_fieldWidth_tag                 3
#define FieldFile_fieldHeight_tag                4
