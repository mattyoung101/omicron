...
/* Generated by nanopb-0.3.9.3 at Wed Feb  5 17:53:45 2020. */
...
const pb_field_t DebugFrame_fields[15] = {
    ...
    PB_FIELD( 12, MESSAGE , REPEATED, STATIC  , OTHER, DebugFrame, robotPositions, mirrorRadius, &RDPoint_fields),
    PB_FIELD( 13, FLOAT   , REPEATED, STATIC  , OTHER, DebugFrame, robotOrientations, robotPositions, 0),
    PB_FIELD( 14, MESSAGE , REPEATED, STATIC  , OTHER, DebugFrame, dewarpedLinePoints, robotOrientations, &RDPoint_fields),
    PB_LAST_FIELD
};
