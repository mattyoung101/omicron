...
const pb_field_t DebugCommand_fields[7] = {
    ...
    PB_FIELD(  5, INT32   , SINGULAR, STATIC  , OTHER, DebugCommand, thresholdId, allThresholds, 0),
    PB_FIELD(  7, INT32   , SINGULAR, STATIC  , OTHER, DebugCommand, value, thresholdId, 0),
    PB_LAST_FIELD
};
