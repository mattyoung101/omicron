...
const pb_field_t DebugCommand_fields[7] = {
    ...
    PB_FIELD(  5, MESSAGE , SINGULAR, STATIC  , OTHER, DebugCommand, threshold, allThresholds, &RDThreshold_fields),
    PB_FIELD(  6, INT32   , SINGULAR, STATIC  , OTHER, DebugCommand, thresholdId, threshold, 0),
    PB_LAST_FIELD
};
