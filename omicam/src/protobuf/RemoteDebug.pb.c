...
const pb_field_t DebugFrame_fields[33] = {
    ...
    PB_FIELD( 32, MESSAGE , SINGULAR, STATIC  , OTHER, DebugFrame, susTriBegin, susRayCutoff, &RDPointF_fields),
    PB_FIELD( 33, MESSAGE , SINGULAR, STATIC  , OTHER, DebugFrame, susTriEnd, susTriBegin, &RDPointF_fields),
    PB_FIELD( 34, MESSAGE , SINGULAR, STATIC  , OTHER, DebugFrame, detectedRobot, susTriEnd, &RDPointF_fields),
    PB_LAST_FIELD
};
