...
// OLD CROP RECT: 242, 36, 797, 620
#define VISION_CROP_RECT 228, 197, 547, 453 // rectangle describing the region of interest that will be applied to the camera frame
