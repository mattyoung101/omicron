...
// Partial source: default libGDX SpriteBatch shader
// See: https://github.com/libgdx/libgdx/blob/master/gdx/src/com/badlogic/gdx/graphics/g2d/SpriteBatch.java (Apache 2)
