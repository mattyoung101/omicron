...
//!< Get an ataom of a worldstate (custom function added by Team Omicron)
extern bool goap_worldstate_get(actionplanner_t *ap, worldstate_t *ws, const char *atomname);
