...
void orbit(robot_state_t *robotState){
    ...
    if(robotState->inRobotId == 0){
        ...
        float ballAngleDifference = ((sign(tempAngle)) * fminf(90, 0.12 * powf(E, 0.1 * (float)smallestAngleBetween(tempAngle, 0)))); // Exponential function for how much extra is added to the ball angle
